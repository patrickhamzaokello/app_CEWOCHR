...
//    private static final String ROOT_URL = "http://192.168.0.155:8080/projects/myfamLinkApp/mobile/api/v1/";
    ...
    public static final String URL_SAVE_NAME =  ROOT_URL + "routes/create_case.php";
